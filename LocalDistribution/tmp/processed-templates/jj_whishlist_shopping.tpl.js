define('jj_whishlist_shopping.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "            <table class=\"whishlist-shopping-table\">\n                <thead>\n                    <tr>\n                        <th>Item ID</th>\n                        <th>Actions</th>\n                    </tr>\n                </thead>\n                <tbody>\n"
  ...
  return "                    <tr>\n                        <td>"
    ...
    return "            <div class=\"whishlist-shopping-empty\">\n                <p>Your wishlist is empty. Start adding items from the store!</p>\n            </div>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<section class=\"whishlist-shopping-container\">\n    <header class=\"whishlist-shopping-header\">\n        <h2>My Wishlist</h2>\n    </header>\n\n    <div class=\"whishlist-shopping-results\">\n"
    ...
    + "    </div>\n</section>\n";
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/JJ/whishlist/1.0.0/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/SC/Horizon/3.2.3/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'jj_whishlist_shopping'; return template;});